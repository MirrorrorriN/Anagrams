...
public class JsonView {
	...
	private Integer errnoFail = -1;
	private Integer errnoSuccess = 0;
	private String errmsgFail = "fail";
	private String errmsgSuccess = "success";
	...
	public JsonView fail(String message) {
		...
		put("errno", this.errnoFail);
		put("errmsg", message);
		return put("info", message);
	}

	public JsonView fail(Integer code, String message) {
		this.isSuccess = false;
		put("errno", code);
		put("errmsg", message);
		return put("info", message);
	...
	public String toJson() {
		...
		if (data.get("errno") == null){
				data.put("errno", this.errnoSuccess);
				data.put("errmsg", this.errmsgSuccess);
